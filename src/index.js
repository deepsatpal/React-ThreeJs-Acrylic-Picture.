...
var GuiConfig = function  () {
    this['Image Path'] = 'img-path';  // default image path
...
//Wireframe color Setting GUI
  ...
  var confi = { color : '#ffae23' };    
  gui.addColor(confi, 'color').onChange( function(colorValue2) {
    wireframe.material.color.set(colorValue2, 'color')
